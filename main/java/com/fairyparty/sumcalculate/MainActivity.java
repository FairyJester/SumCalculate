...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClick(View view) {
        TextView firstTerm = findViewById(R.id.editText);
        TextView secondTerm = findViewById(R.id.editText2);
        try {
    ...
    protected void resetUI() {
        TextView countScore = findViewById(R.id.editText);
        countScore.setText(String.valueOf(count));
        TextView secondScore = findViewById(R.id.editText2);
